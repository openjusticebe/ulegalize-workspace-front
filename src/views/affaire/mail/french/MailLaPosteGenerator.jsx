...
import { generateMail } from '../../../../services/LaPosteFrenchService';
...
const MailLaPosteGenerator = ( { showMessage, label, documentId } ) => {
    ...
    useEffect( () => {
        (async () => {
            ...
            let result;
                ...
                if ( !result.error ) {
                    let pdf = b64toBlob( result.data.binary, '' );
                    setFile( pdf );
                } else {
...
export default MailLaPosteGenerator;