...
export default function TiersAffaireTable( props ) {
    const { label } = props;
    ...
    useEffect( () => {
        (async () => {
            ...
            let resultCount = await countComptaByDossierId( accessToken, props.affaireid, null, null, null, true );
    ...
    useEffect( () => {
        (async () => {
            ...
            let result = await getComptaByDossierId( accessToken, props.affaireid, offset, pageSize , null, null, null, true);
            if ( !result.error ) {
