...
export default function DeboursAffaireTable( props ) {
    const { label } = props;
    ...
    useEffect( () => {
        (async () => {
            ...
            let resultCount = await countComptaByDossierId( accessToken, props.affaireid, true );
    ...
    useEffect( () => {
        (async () => {
            ...
            let result = await getComptaByDossierId( accessToken, props.affaireid, offset, pageSize , true);
            if ( !result.error ) {
