...
export default function FraiCollaborationAffaireTable( props ) {
    const { label } = props;
    ...
    useEffect( () => {
        (async () => {
            ...
            let resultCount = await countComptaByDossierId( accessToken, props.affaireid, null, true );
    ...
    useEffect( () => {
        (async () => {
            ...
            let result = await getComptaByDossierId( accessToken, props.affaireid, offset, pageSize , null, true);
            if ( !result.error ) {
