...
export default function ComptaAffaireTable( props ) {
    const { label } = props;
    ...
    useEffect( () => {
        (async () => {
            ...
            let resultCount = await countComptaByDossierId( accessToken, props.affaireid );
    ...
    useEffect( () => {
        (async () => {
            ...
            let result = await getComptaByDossierId( accessToken, props.affaireid, offset, pageSize );
            if ( !result.error ) {
